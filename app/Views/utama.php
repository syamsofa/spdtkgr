...
<head>
  ...
  <title>Pengolahan SPDT24-KGr </title>
    ...
    <div class="layout-container">
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item">
            <a href="<?= base_url() ?>daftar_sampel" target="_blank" class="menu-link">
              <i class="menu-icon tf-icons bx bx-grid"></i>
              <div data-i18n="Kanban">Sampel</div>
            </a>
          </li>
          <!-- Pages -->
          <li class="menu-item">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-lg-12 col-xl-12 order-0 mb-4">
                <div class="card h-100">
                  ...
                  <div class="card-body">
                    <?php 
                    if($uri->getSegment(1)=='daftar_sampel') 
                    echo view('daftar_sampel');
